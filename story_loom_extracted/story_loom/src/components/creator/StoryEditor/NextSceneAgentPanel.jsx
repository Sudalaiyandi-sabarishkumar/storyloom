export default function NextSceneAgentPanel({ options, onPick, generating, loading }) {
  return (
    <div className="agent-panel card">
      ...
      {loading && (
        <div className="generating-line">
          ...
          Thinking up next directions…
        </div>
      )}

      {!loading && options.length === 0 && (
        <div style={{ fontSize: '12.5px', color: 'var(--c-text-dim)', marginTop: '10px' }}>
          No suggestions yet.
        </div>
      )}
