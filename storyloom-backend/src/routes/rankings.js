...
router.post('/projects/:id/rankings/recompute', asyncHandler(async (req, res) => {
...
router.get('/projects/by-title/:title/audience-simulation', asyncHandler(async (req, res) => {
  const forceRecompute = req.query.refresh === 'true';
