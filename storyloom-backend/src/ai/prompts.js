...
export const RANKING_PROMPT_VERSION = 'ranking-v2';
...
export const AUDIENCE_PROMPT_VERSION = 'audience-v2';
export function audienceSystemPrompt() {
  return [
    ...
    'green-light meeting, naming the single weakest demographic by name and why it drags the score) }.',
  ].join('\n');
}
